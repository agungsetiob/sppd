					...
					<div class="main-header-left ">
						<div class="responsive-logo">
							<a href="/" class="header-logo">
								<img src="/assets/img/logo.png" class="logo-1" alt="logo">
								<img src="/assets/img/logo.png" class="dark-logo-1" alt="logo">
							</a>
						</div>
					...
					<div class="main-sidebar-header active">
						<a class="desktop-logo logo-light active text-decoration-none" href="/">
							<div class="d-flex justify-content-center align-items-center">
								<img src="/assets/img/logo.png" class="main-logo m-0" alt="logo">
